...
from shapely_ext.decompose import Decompose
...
class TestDecompose(TestCase):
    def test_decompose_polygon(self):
        ...
        lines1 = Decompose.decompose_to_line(geometry=polygon1)
        ...
        lines2 = Decompose.decompose_to_line(geometry=polygon2)
        ...
        line3 = Decompose.decompose_to_line(polygon3, min_corner_angle_degree=15)
